...
local Themes = {
	Light = {
		...
		NavBarAccent = Color3.fromRGB(31,31,31),
		...
		BannerAccent = Color3.fromRGB(31,31,31),
		...
		ColorPickerAccent = Color3.fromRGB(31,31,31),
		TextField = Color3.fromRGB(255,255,255),
		TextFieldAccent = Color3.fromRGB(253,253,253),
	},
	Dark = {

...
local Themes = {
	Light = {
		...
		NavBar = Color3.fromRGB(21,21,21),
		NavBarAccent = Color3.fromRGB(30,30,30),
		NavBarInvert = Color3.fromRGB(30,30,30),
		TitleBar = Color3.fromRGB(87,101,242),
		TitleBarAccent = Color3.fromRGB(31,31,31),
		Overlay = Color3.fromRGB(87,101,242),
		Banner = Color3.fromRGB(31,31,31),
		BannerAccent = Color3.fromRGB(87,101,242),
		Content = Color3.fromRGB(87,101,242),
		Button = Color3.fromRGB(87,101,242),
		ButtonAccent = Color3.fromRGB(31,31,31),
		ChipSet = Color3.fromRGB(87,101,242),
		ChipSetAccent = Color3.fromRGB(31,31,31),
		DataTable = Color3.fromRGB(87,101,242),
		DataTableAccent = Color3.fromRGB(31,31,31),
		Slider = Color3.fromRGB(31,31,31),
		SliderAccent = Color3.fromRGB(87,101,242),
		Toggle = Color3.fromRGB(87,101,242),
		ToggleAccent = Color3.fromRGB(31,31,31),
		Dropdown = Color3.fromRGB(31,31,31),
		DropdownAccent = Color3.fromRGB(87,101,242),
		ColorPicker = Color3.fromRGB(31,31,31),
		ColorPickerAccent = Color3.fromRGB(87,101,242),
		TextField = Color3.fromRGB(87,101,242),
		TextFieldAccent = Color3.fromRGB(87,101,242),
	},
	Dark = {
